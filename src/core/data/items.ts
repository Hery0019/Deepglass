...
export const ITEMS: Readonly<Record<ItemId, ItemDef>> = {
  "health-potion": {
    ...
    color: "#e06060",
    category: "potion",
    description: "Restores 10 health and cures poison.",
    effect: { type: "heal", amount: 10, cures: ["poison"] },
    minDepth: 1,
    maxDepth: 9,
    weight: 14,
  },
  "scroll-of-flame": {
    ...
    color: "#e0a458",
    category: "scroll",
    description: "Burns every creature within 3 tiles of you for 6-12 damage.",
  ...
  "scroll-of-bewilderment": {
    ...
    color: "#d17fd1",
    category: "scroll",
    description: "Confuses every creature within 4 tiles of you for 8 turns.",
