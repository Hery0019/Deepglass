...
export const ITEMS: Readonly<Record<ItemId, ItemDef>> = {
  ...
  "food-ration": {
    ...
    color: "#c8a165",
    category: "food",
    description: "Dried meat and hard bread. Restores 1000 food.",
    effect: { type: "feed", amount: 1000 },
    minDepth: 1,
    maxDepth: 9,
    weight: 16,
  },
  ...
  "short-bow": {
    ...
    color: "#a67c52",
    category: "bow",
    description: "Shoots for 2-5 up to 6 tiles away. f fires.",
  ...
  "long-bow": {
    ...
    color: "#c49a6c",
    category: "bow",
    description: "Shoots for 4-9 up to 8 tiles away. f fires.",
